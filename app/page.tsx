      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="space-y-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            We're working hard to improve our website and we'll be back on March 8, 2025 at 18:00. Thank you for your patience!
          </p>
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="bg-white p-4 rounded-lg shadow-md">
                <div className="text-3xl font-bold text-primary">{timeLeft.hours.toString().padStart(2, '0')}</div>
                <div className="text-sm text-gray-500">Hours</div>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-md">
                <div className="text-3xl font-bold text-primary">{timeLeft.minutes.toString().padStart(2, '0')}</div>
                <div className="text-sm text-gray-500">Minutes</div>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-md">
                <div className="text-3xl font-bold text-primary">{timeLeft.seconds.toString().padStart(2, '0')}</div>
